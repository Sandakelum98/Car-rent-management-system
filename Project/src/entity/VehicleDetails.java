...
public class VehicleDetails {
    ...
    public VehicleDetails(int makeId, String makeName, int modelId, String modelName, int vehicleId, String vehicleNo, int vehicleYear, String colour, int isActive, String isActiveName, int priceCateId, String priceCateName, double defaultRate, int km, double addingRate) {
        this.makeId = makeId;
