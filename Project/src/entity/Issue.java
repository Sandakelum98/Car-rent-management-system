...
public class Issue {
    ...
    public Issue(String custName, String custNIC, String custAddress, String mobileNo, String vehicleMake, String getVehicleModel, String vehicleNo, int vehicleYear, String vehicleColour, int resId, int resDetailId, double defaultRate, int km, double addingRate, String fromDate, String toDate) {
